...
# Set font to nothing and size to 36
...
# Create target position variable
target_pos = (1000, 300)
...
while running:
    # poll for events
    # pygame.QUIT event means the user clicked esc to close your window
