...
npc_pos = pygame.Vector2(round(screen.get_width() / 3, -2), round(screen.get_height() / 3, -2))
...
images = {
    "b_melee_1": pygame.transform.scale(pygame.image.load("british_melee.png"), (150, 150)),
    "b_melee_2": pygame.transform.scale(pygame.image.load("british_melee_attack.png"), (150, 150)),
    "m_melee_1": pygame.transform.scale(pygame.image.load("maori_melee.png"), (150, 150)),
...
sprite = MeleeSprite(images["b_melee_1"], on_click, player_pos)
