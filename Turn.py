...
turn = True
images = {
    "b_melee_1": pygame.transform.scale(pygame.image.load("british_melee.png"), (100, 100)),
    ...
    "m_melee_1": pygame.transform.scale(pygame.image.load("maori_melee.png"), (100, 100)),
